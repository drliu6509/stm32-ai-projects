...
//////////////////////////////////////////////////////////////////////////////////
//ALIENTEK探索者STM32F407开发板  LVGL时钟例程
//使用TIM3定时器(1ms)驱动LVGL tick时钟
//表盘实时显示当前时间,下方显示日期,点击SET可设置时间/日期
...
int main(void)
{
	...
	printf("\r\n==== ATK-Explorer F407 LVGL Clock Start ====\r\n");
	...
	My_RTC_Init();		//RTC初始化(默认日期2026-01-01)
	printf("My_RTC_Init OK\r\n");
	...
	clock_ui_init();			//创建时钟界面
	printf("clock_ui_init OK\r\n");
