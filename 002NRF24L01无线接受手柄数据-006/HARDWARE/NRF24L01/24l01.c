...
// ���͵�ַ: ƥ��Arduino����0x0011000011LL (LSB first, 5�ֽ�)
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x11,0x00,0x00,0x11,0x00};
// ���յ�ַ: ���͵�ַһ��(һ�㲥ͨ)
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x11,0x00,0x00,0x11,0x00};
...
void NRF24L01_RX_Mode(void)
{
	NRF24L01_CE=0;	  
  	...
  	NRF24L01_Write_Buf(NRF_WRITE_REG+TX_ADDR,(u8*)TX_ADDRESS,TX_ADR_WIDTH);  //дTX�ڵ��ַ(���ڷ��ͻظ�ACK,���ڱ����Checkд���0xA5)
	  
  	NRF24L01_Write_Reg(NRF_WRITE_REG+EN_AA,0x01);       //ʹ��ͨ��0���Զ�Ӧ��    
  	NRF24L01_Write_Reg(NRF_WRITE_REG+EN_RXADDR,0x01);   //ʹ��ͨ��0�Ľ��յ�ַ
	NRF24L01_Write_Reg(NRF_WRITE_REG+SETUP_AW,0x03);     //5�ֽڵ�ַ����(ƥ��Arduino)
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,115);	    //����RFͨ��Ƶ��(ƥ��Arduino CH115)
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RX_PW_P0,RX_PLOAD_WIDTH);//ѡ��ͨ��0����Ч���ݿ���
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_SETUP,0x07);    //1Mbps, 0dBm, ���������濪��(ƥ��Arduino RF24_1MBPS)
  	NRF24L01_Write_Reg(NRF_WRITE_REG+CONFIG, 0x0f);     //���û�������ģʽ�Ĳ���;PWR_UP,EN_CRC,16BIT_CRC,����ģʽ
	/* ʹ�ö�̬���س��Ⱥ�ACK Payload(DPL+ACK_PAY),ƥ��Arduino enableDynamicPayloads()+enableAckPayload() */
	NRF24L01_Write_Reg(0x1C, 0x01);                     //DYNPD: Pipe0ʹ�ܶ�̬����
	NRF24L01_Write_Reg(0x1D, 0x06);                     //FEATURE: EN_DPL | EN_ACK_PAY
